Vagrant.configure("2") do |config|
  ...
  config.vm.provider "virtualbox" do |v|
    v.customize "pre-boot", [
      ...
      "--device", "1",
      "--type", "dvddrive",
      "--medium", File.expand_path("../boot2docker-vagrant_1-6-0.iso", __FILE__),
    ]
  end
  ...
  ["vmware_fusion", "vmware_workstation"].each do |vmware|
    config.vm.provider vmware do |v|
      ...
      v.vmx["ide1:0.fileName"]   = File.expand_path("../boot2docker-vagrant_1-6-0.iso", __FILE__)
  ...
  config.vm.provider "parallels" do |v|
    v.customize "pre-boot", [
      ...
      "--device-add", "cdrom",
      "--enable", "--connect",
      "--image", File.expand_path("../boot2docker-vagrant_1-6-0.iso", __FILE__)
    ]
    v.customize "pre-boot", [
      "set", :id,
